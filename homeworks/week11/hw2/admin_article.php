...
<head>
  ...
  <title><?php echo escape($row['title']); ?> - 管理後台</title>
        ...
        <section class="article">
          <article class="article__item">
            <div class="article__actions">
              <a class="btn__admin" href="admin_update_article.php?id=<?php echo escape($row['id']) ?>">
                <span class="material-icons icon-m">edit</span>
                編輯
              </a>
              <a class="btn__admin" href="handle_delete_article.php?id=<?php echo escape($row['id']) ?>">
